      ...
      <div className="grid md:grid-cols-3 gap-8">
        <div className="md:col-span-2 flex flex-col gap-8">
          <section>
            ...
            <div className="bg-[var(--color-surface)] border border-[var(--color-line)] rounded-lg px-5">
              {steps.map((s) => (
        ...
        <div className="flex flex-col gap-6">
          ...
          <section>
            ...
            <div className="bg-[var(--color-surface)] border border-[var(--color-line)] rounded-lg p-4 flex flex-col gap-3 text-sm">
