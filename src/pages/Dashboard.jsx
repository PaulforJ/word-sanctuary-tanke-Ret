...
export default function Dashboard() {
  ...
  return (
    <div>
      {/* Hero banner — background photo, slow continuous zoom, inside the app */}
      <div className="relative -mx-5 -mt-5 md:-mx-10 md:-mt-10 mb-8 overflow-hidden rounded-b-2xl md:rounded-2xl">
        <div className="relative h-40 md:h-52">
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(115deg, rgba(15,31,29,0.88) 20%, rgba(15,31,29,0.55) 60%, rgba(15,31,29,0.25) 100%)',
            }}
            aria-hidden="true"
          />
